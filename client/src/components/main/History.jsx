  ...
  return (
    <div
      ...
      <div className=" py-[40px] text-md font-bold h-full lg:text-[50px] text-[#395143] leading-1 xl:text-[60px] w-full flex flex-col justify-center items-center">
        ...
        <div className=" w-full px-[5%] xl:px-[12%] pt-[5%] hidden lg:grid grid-cols-3  gap-[40px] xl:gap-[80px]">
        ...
        <Swiper
          ...
          freeMode={true}
          modules={[FreeMode]}
          className="h-full py-[40px] flex lg:hidden px-[30px] w-full">
          <SwiperSlide>
            <div className="px-[20px]  drop-shadow w-full rounded-[40px] lg:px-[10px]  h-[340px] bg-[#D6D2BD80] flex flex-col justify-center items-center">
              <img src={func1} className="w-[50%] lg:w-[70%] xl:w-[60%] " />
