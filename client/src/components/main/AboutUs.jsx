...
const AboutUs = () => {
  ...
  return (
    <div className="bg-[#395143] flex flex-col items-center text-[#E7E4D5] px-[30px] lg:px-[70px] xl:px-[108px] w-full md:grid md:grid-cols-[45%,55%] lg:grid-cols-2 pt-[100px] lg:h-screen md:py-[70px] lg:py-[150px] lg:gap-[5%] xl:gap-[10%]">
