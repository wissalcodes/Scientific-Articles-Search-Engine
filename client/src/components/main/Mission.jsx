...
const Mission = () => {
  return (
    <div className=" w-full lg:pt-[160px] pt-[120px] px-[30px] h-full flex-col justify-center items-center lg:px-[70px] xl:px-[108px]">
      <div className="w-full justify-center items-start">
        <div className=" lg:text-[50px] text-[24px] leading-[1] xl:text-[60px] font-bold w-full flex  justify-center items-center">
          <h1 className="font-merryweather  text-[20px] lg:text-[50px] xl:text-[60px]   text-[#395143]">
            Notre Mission
          </h1>
        </div>
        <div className="pt-[30px] w-full xl:text-[30px] text-[16px] lg:text-[20px] font-light flex justify-start font-lora items-center">
          <Typed
