...
const Navbar = () => {
  return (
    <div className="px-[30px] py-[10px] z-20 font-bold top-0 bg-[#395143] fixed w-full h-[80px] text-[14px] xl:text-[20px] grid-cols-[1fr,1fr] gap-[10px] lg:gap-0 lg:grid-cols-[5fr,1fr,1fr] grid justify-center items-center">
